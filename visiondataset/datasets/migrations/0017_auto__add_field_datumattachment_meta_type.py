...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatumAttachment.meta_type'
        db.add_column('datasets_datumattachment', 'meta_type',
                      self.gf('django.db.models.fields.TextField')(default='unknow'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatumAttachment.meta_type'
        db.delete_column('datasets_datumattachment', 'meta_type')
    ...
    models = {
        ...
        'datasets.datumattachment': {
            ...
            'meta_type': ('django.db.models.fields.TextField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
