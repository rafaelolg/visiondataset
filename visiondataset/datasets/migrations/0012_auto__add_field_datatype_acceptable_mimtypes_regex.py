...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataType.acceptable_mimtypes_regex'
        db.add_column('datasets_datatype', 'acceptable_mimtypes_regex',
                      self.gf('django.db.models.fields.CharField')(default='.*', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataType.acceptable_mimtypes_regex'
        db.delete_column('datasets_datatype', 'acceptable_mimtypes_regex')
