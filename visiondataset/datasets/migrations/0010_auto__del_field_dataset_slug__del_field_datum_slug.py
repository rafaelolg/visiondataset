...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('datasets_datum', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(default='', populate_from=['dataset', 'name'], allow_duplicates=False, max_length=50, separator=u'-', blank=True, overwrite=False),
                      keep_default=False)
