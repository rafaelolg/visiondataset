...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatumAttachment.meta_description'
        db.add_column('datasets_datumattachment', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatumAttachment.meta_description'
        db.delete_column('datasets_datumattachment', 'meta_description')
