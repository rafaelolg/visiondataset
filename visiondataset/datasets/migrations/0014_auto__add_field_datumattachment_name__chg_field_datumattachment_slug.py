...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatumAttachment.name'
        db.add_column('datasets_datumattachment', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


        # Changing field 'DatumAttachment.slug'
        db.alter_column('datasets_datumattachment', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from='name', overwrite=False))

    def backwards(self, orm):
        # Deleting field 'DatumAttachment.name'
        db.delete_column('datasets_datumattachment', 'name')


        # Changing field 'DatumAttachment.slug'
        db.alter_column('datasets_datumattachment', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(populate_from='package', allow_duplicates=False, max_length=50, separator=u'-', overwrite=False))
