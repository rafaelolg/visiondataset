...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DatumAttachment.slug'
        db.delete_column('datasets_datumattachment', 'slug')

        # Deleting field 'DatumAttachment.description'
        db.delete_column('datasets_datumattachment', 'description')

        # Adding field 'DatumAttachment.original_name'
        db.add_column('datasets_datumattachment', 'original_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DatumAttachment.slug'
        db.add_column('datasets_datumattachment', 'slug',
        ...
        # Adding field 'DatumAttachment.description'
        db.add_column('datasets_datumattachment', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'DatumAttachment.original_name'
        db.delete_column('datasets_datumattachment', 'original_name')
    ...
    models = {
        ...
        'datasets.datumattachment': {
            'Meta': {'ordering': "('name', '-created')", 'object_name': 'DatumAttachment'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
